...
Настройте агента под себя для более персонализированного опыта:

```bash
# Скопируйте пример профиля
cp agent-profile.example.json agent-profile.json

# Отредактируйте под свои предпочтения
nano agent-profile.json
```

Профиль позволяет настроить:
- 👤 Имя, роль, часовой пояс, язык
- 🎨 Стиль общения и детализацию ответов
- 💼 Рабочий контекст и технологический стек
- ⏰ Рабочие часы и привычки
- 📝 Кастомные инструкции для агента

**Подробнее:** [docs/PERSONALIZATION.md](docs/PERSONALIZATION.md)
